  ...
  return (
    <>
        <div
            ...
            aria-hidden="true"
        />
        <aside className={`fixed top-0 left-0 h-full w-72 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl p-4 flex flex-col border-r border-slate-900/5 dark:border-white/10 z-30 transition-transform duration-300 ease-in-out md:relative md:translate-x-0 flex-shrink-0 ${isMobileOpen ? 'translate-x-0' : '-translate-x-full'} ${className || ''}`}>
