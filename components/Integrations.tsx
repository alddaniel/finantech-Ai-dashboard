...
export const Integrations: React.FC<IntegrationsProps> = ({ isAccountantModuleEnabled, setIsAccountantModuleEnabled }) => {
            ...
            <Card>
                <CardHeader>
                    <h2 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                     ...
                     <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Faça o upload do arquivo de extrato fornecido pelo seu banco.</p>
                </CardHeader>
                <CardContent className="pt-4">
...
const OpenFinanceIcon = () => <svg className="w-6 h-6 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>;
