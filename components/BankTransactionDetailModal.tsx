...
export const BankTransactionDetailModal: React.FC<BankTransactionDetailModalProps> = ({ transaction, account, onClose }) => {
    return (
        ...
        >
            <div
                className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-xl shadow-2xl shadow-black/20 dark:shadow-black/60 ring-1 ring-slate-900/5 dark:ring-white/10 w-full max-w-lg max-h-[90vh] flex flex-col"
